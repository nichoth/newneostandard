...
/**
 * @param {NewneostandardOptions} [options]
 * @returns {import('eslint').Linter.Config[]}
 */
function newneostandard (options) {
  const {
    env,
    files: rawFiles,
    filesTs,
  ...
  return [
    ...
    ...files.length
      ? [{
          name: 'newneostandard/additional-files',
          files,
        }]
      : [],
